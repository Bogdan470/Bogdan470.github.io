...
$(function () {
  ...
  var checkResults = function checkResults(e) {
    ...
    var $body = $('#modal_form');
    if (testOK) {
      $modal = '<div class="mymodal_green reset_my_modal"><div><h2 class="text_test_zdan">Тест успешно сдан!</h2><div class="text_answered">Правильно ' + answered + ', с ' + questionsQuantity + ' вопросов </div></div></div>';
    } else {
      $modal = '<div class="mymodal_red reset_my_modal"><h2 class="text_test_zdan">Тест сдан плохо.</h2> <div class="text_answered">Правильно ' + answered + ' , с ' + questionsQuantity + ' вопросов </div></div>';
    }
